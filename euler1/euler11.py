...
import ...euler0.euler8
def new_product(product,num1,num2):
    if num1 != 0:
        product /= num1
    product *= num2
    return product
    ...
    for i in range(gridSize):
        ...
        for j in range(gridSize):
            if grid[i][j] == 0:
                ...
                product = new_product(product,grid[i][j-n],grid[i][j])
    ...
    for i in range(gridSize):
        ...
        for j in range(gridSize):
            if grid[j][i] == 0:
                ...
                product = new_product(product,grid[j-n][i],grid[j][i])
            if maxProduct < product:
                maxProduct = product
    #diagonals
    for i in range(20):
        ...
        for j in range(0,20-i):
            if grid[i][j] == 0:
                ...
                product = new_product(product,grid[i][j],grid[i][j])
            if maxProduct < product:
                maxProduct = product
    for i in range(20):
        product = 1
